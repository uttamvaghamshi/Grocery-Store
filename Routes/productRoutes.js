...
import { addProduct, deleteProduct, getLikedProducts, getMyStoreProducts,getNearestStoreProducts, getNearestStoreProductsByCategory, getNearestStoreProductsSingle, getSingleProduct, updateProduct } from '../Controller/ProductController.js';
...
router.get('/get-products/:id',authMiddleware,UserRoleMiddleware,getNearestStoreProductsSingle);
